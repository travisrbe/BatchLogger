...
namespace Services
{
    internal sealed class BatchLogEntryService : IBatchLogEntryService
    {
        ...
        {
            var UserOwnsBatch = await _repositoryManager.BatchRepository.UserOwnsBatch(userId, batchLogEntryDto.BatchId, cancellationToken);
            var UserContributesBatch = await _repositoryManager.BatchRepository.UserContributesBatch(userId, batchLogEntryDto.BatchId, cancellationToken);
        ...
        {
            var UserOwnsBatch = await _repositoryManager.BatchRepository.UserOwnsBatch(batchLogEntryDto.UserId, batchLogEntryDto.BatchId, cancellationToken);
        ...
        {
            var UserOwnsBatch = await _repositoryManager.BatchRepository.UserOwnsBatch(userId, batchId, cancellationToken);
            var UserContributesBatch = await _repositoryManager.BatchRepository.UserContributesBatch(userId, batchId, cancellationToken);
            if (UserOwnsBatch || UserContributesBatch)
            {
