...
namespace Service.Abstractions
{
    ...
    {
        Task<BatchLogEntryDto> Create(string userId, Guid batchId, CancellationToken cancellationToken = default);
        Task<BatchLogEntryDto> Create(string userId, IEnumerable<NutrientAdditionDto> nuAdds, CancellationToken cancellationToken = default);
